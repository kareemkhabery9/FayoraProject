...
namespace Fayora.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260618183507_AddVerificationUrl")]
    partial class AddVerificationUrl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HousingUnitMasterAmenities", b =>
                {
                    b.Property<Guid>("HousingUnitId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("MasterAmenityId")
                        .HasColumnType("int");

                    b.HasKey("HousingUnitId", "MasterAmenityId");

                    b.HasIndex("MasterAmenityId");

                    b.ToTable("HousingUnitMasterAmenities");
                });
            ...
            modelBuilder.Entity("Fayora.Domain.Entities.AccommodationModule.HousingUnit", b =>
                {
                    ...
                    b.OwnsOne("Fayora.Domain.ValueObjects.FileUrl", "VerificationDocumentUrl", b1 =>
                        {
                            b1.Property<Guid>("HousingUnitId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.Navigation("VerificationDocumentUrl")
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Fayora.Domain.Entities.AccommodationModule.MasterAmenity", b =>
                {
                    b.OwnsOne("Fayora.Domain.ValueObjects.FileUrl", "Icon", b1 =>
                        {
                            b1.Property<int>("MasterAmenityId")
                                .HasColumnType("int");
                            ...
                            b1.HasKey("MasterAmenityId");

                            b1.ToTable("MasterAmenities");

                            b1.WithOwner()
                                .HasForeignKey("MasterAmenityId");
                        });
